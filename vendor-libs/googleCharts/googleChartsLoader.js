...
*/
    ...
    q("String.prototype.startsWith", function (a) {
        return a ? a : function (b, c) {
            var d = r(this, b, "startsWith"), e = d.length, f = b.length;
            c = Math.max(0, Math.min(c | 0, d.length));
    ...
    q("Promise", function (a) {
        ...
        b.prototype.B = function (g) {
            if (g === this) this.h(new TypeError("A Promise cannot resolve to itself")); else if (g instanceof b) this.H(g); else {
                a:switch (typeof g) {
                    case "object":
                        var h = null != g;
                        break a;
    ...
    q("Array.prototype.copyWithin", function (a) {
        ...
        return a ? a : function (c, d, e) {
            ...
            if (c < d) for (; d < e;) d in this ? this[c++] = this[d++] : (delete this[c++], d++); else for (e = Math.min(e, f + d - c), c += e - d; e > d;) --e in this ? this[--c] = this[e] : delete this[--c];
            return this
        }
    });
    q("Symbol", function (a) {
    ...
    q("Map", function (a) {
        ...
        function d(h, k) {
            ...
            var p = h.b[m];
            if (p && t(h.b, m)) for (h = 0; h < p.length; h++) {
                var x = p[h];
    ...
    q("String.prototype.codePointAt", function (a) {
        return a ? a : function (b) {
            var c = r(this, null, "codePointAt"), d = c.length;
            b = Number(b) || 0;
            if (0 <= b && b < d) {
                b |= 0;
    ...
    q("String.prototype.matchAll", function (a) {
        return a ? a : function (b) {
            ...
            var c = new RegExp(b, b instanceof RegExp ? void 0 : "g"), d = this, e = !1, f = {
                next: function () {
                    var g = {}, h = c.lastIndex;
    ...
    var w = this || self, ta = /^[\w+/_-]+[=]{0,2}$/, ua = null;
    ...
    var Sa = /%{(\w+)}/g, Ra = /^((https:)?\/\/[0-9a-z.:[\]-]+\/|\/[^/\\]|[^:/\\%]+\/|[^:/\\%]*[?#]|about:blank#)/i,
        Ua = /^([^?#]*)(\?[^#]*)?(#[\s\S]*)?/;
    ...
    };var gb = M("Opera"), hb = M("Trident") || M("MSIE"), ib = M("Edge"),
        jb = M("Gecko") && !(-1 != L.toLowerCase().indexOf("webkit") && !M("Edge")) && !(M("Trident") || M("MSIE")) && !M("Edge"),
        kb = -1 != L.toLowerCase().indexOf("webkit") && !M("Edge"), lb;
    a:{
        var mb = "", nb = function () {
            var a = L;
        ...
        if (0 == a.a) {
            ...
            a:{
                ...
                if (d instanceof N) {
                    ...
                    var g = !0
                } else if (Kb(d)) d.then(e, f, a), g = !0; else {
                    if (za(d)) try {
                        var h = d.then;
                        if (B(h)) {
                            Ub(d, h, e, f, a);
    ...
    function Rb(a, b, c, d) {
        ...
        if (b.a) b.a.c = null, Wb(b, c, d); else try {
...
*/
    ...
    function jc(a, b) {
        ...
        var d = Pa(a).toString(), e = ub("SCRIPT"), f = {P: e, S: void 0}, g = new Q(kc, f), h = null,
    ...
    function sc(a, b) {
        ...
        } else if (a) if (a instanceof sc) for (c = a.C(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d])); else for (d in a) this.set(d, a[d])
    }
    ...
    wc.prototype.resolve = function (a) {
        var b = new wc(this), c = !!a.g;
        c ? xc(b, a.g) : c = !!a.j;
        c ? b.j = a.j : c = !!a.a;
        c ? b.a = a.a : c = null != a.m;
        var d = a.b;
        if (c) yc(b, a.m); else if (c = !!a.b) {
    ...
    l.D = function (a) {
        V(this);
        var b = [];
        if ("string" === typeof a) Lc(this, a) && (b = Ja(b, this.a.get(W(this, a)))); else {
            a = this.a.D();
    ...
    function Uc(a) {
        var b = J.f.I.ha[Oc].loader, c = Tc(a);
    ...
    function cd(a, b, c) {
        ...
        var d = c.libraries, e = function (h) {
            ...
            return h.split("=")
        }) : []), f = Object.assign({}, {key: a, sa: d}, e), g = "2" === b ? bd : ad;

...
-->
            ...
            <div class="dropdown styleButton1 main_text_color-1 main_bkg_color-1">
                <div class="">Экспорт</div>
                <div class="dropdown-child">
                    <a href="#" class="dropdown-item"
                       onclick="GeoController.exportGeo('kml')">KML</a>
                    <a href="#" class="dropdown-item"
                       onclick="GeoController.exportGeo('gpx')">GPX</a>
                </div>

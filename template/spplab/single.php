  ...
  <header class="header-bar d-flex d-lg-block align-items-center site-navbar-target" data-aos="fade-right">
    ...
    <div class="main-menu">
      <ul class="js-clone-nav">
        <li><a href="index.html#index.php" class="nav-link">Home</a></li>
        <li><a href="index.html#index.php" class="nav-link">Photos</a></li>
        <li><a href="index.html#index.php" class="nav-link">Biography</a></li>
        <li class="active"><a href="index.html#index.php" class="nav-link">Blog</a></li>
        <li><a href="index.html#index.php" class="nav-link">Contact</a></li>
      </ul>
